...
//     version 1.7.0
//     from Assets/_Wormcatcher/Scripts/FPS_Inputs.inputactions
//
...
public partial class @PlayerInputAction: IInputActionCollection2, IDisposable
{
    ...
    private List<IWalkInputActions> m_WalkInputActionsCallbackInterfaces = new List<IWalkInputActions>();
    ...
    public struct WalkInputActions
    {
        ...
        public void AddCallbacks(IWalkInputActions instance)
        {
            if (instance == null || m_Wrapper.m_WalkInputActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_WalkInputActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IWalkInputActions instance)
        {
            @Movement.started -= instance.OnMovement;
            @Movement.performed -= instance.OnMovement;
            @Movement.canceled -= instance.OnMovement;
        ...
        public void RemoveCallbacks(IWalkInputActions instance)
        {
            if (m_Wrapper.m_WalkInputActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IWalkInputActions instance)
        {
            foreach (var item in m_Wrapper.m_WalkInputActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_WalkInputActionsCallbackInterfaces.Clear();
    ...
    private List<IStaticInputActions> m_StaticInputActionsCallbackInterfaces = new List<IStaticInputActions>();
    ...
    public struct StaticInputActions
    {
        ...
        public void AddCallbacks(IStaticInputActions instance)
        {
            if (instance == null || m_Wrapper.m_StaticInputActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_StaticInputActionsCallbackInterfaces.Add(instance);
            @Newaction.started += instance.OnNewaction;
            @Newaction.performed += instance.OnNewaction;
            @Newaction.canceled += instance.OnNewaction;
        }

        private void UnregisterCallbacks(IStaticInputActions instance)
        {
            @Newaction.started -= instance.OnNewaction;
            @Newaction.performed -= instance.OnNewaction;
            @Newaction.canceled -= instance.OnNewaction;
        ...
        public void RemoveCallbacks(IStaticInputActions instance)
        {
            if (m_Wrapper.m_StaticInputActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IStaticInputActions instance)
        {
            foreach (var item in m_Wrapper.m_StaticInputActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_StaticInputActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
